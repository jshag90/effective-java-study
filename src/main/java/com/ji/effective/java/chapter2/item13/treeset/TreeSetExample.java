package com.ji.effective.java.chapter2.item13.treeset;

import com.ji.effective.java.chapter2.item13.PhoneNumber;
...
//        numbers.add(6);
        ...
        TreeSet<PhoneNumber> numbers = new TreeSet<>(Comparator.comparing(PhoneNumber::hashCode));
